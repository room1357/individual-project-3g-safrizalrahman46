...
class RestClient {
  ...
  /// API key khusus untuk NewsAPI
  static const String _newsApiKey = '571bab6331dc497bb9e573e8f5b4adbd';
  ...
  Future<Post> fetchPost(int id) async {
    ...
    final resp = await _httpClient.get(uri, headers: {'Accept': 'application/json'});
    if (resp.statusCode == 200) {
  ...
  Future<Post> updatePost(Post post) async {
    ...
    _throwForStatus(
        'Failed to update post ${post.id}', resp.statusCode, resp.body);
  }
  ...
  Future<Map<String, dynamic>> fetchNews({
    ...
    final uri = Uri.parse('$_newsBaseUrl/$endpoint').replace(queryParameters: {
      ...?query,
      'apiKey': _newsApiKey,
    });
    ...
    if (resp.statusCode == 200) {
      ...
      _throwForStatus('Failed to fetch news', resp.statusCode, resp.body);
    }
  }
